...
insert  into `address`(`id`,`userId`,`address`,`addressDetail`,`isDelete`) values (1,2,'北京市海淀区','西三旗建材城西路',1),(2,2,'天津市南开区','红旗南路',1);
...
insert  into `brand`(`id`,`brandName`,`categoryId`,`brandLogo`,`isDelete`,`hot`) values (1,'耐克',1,'/pic/1.jpg',1,1),(2,'阿迪',1,'/pic/2.jpg',1,1),(3,'新百伦',1,'/pic/3.jpg',1,1),(4,'哥伦比亚',1,'/pic/4.jpg',1,0),(5,'匡威',1,'/pic/5.jpg',1,1),(6,'哈哈',1,NULL,1,NULL),(7,'哈哈',1,NULL,1,NULL),(8,'哈哈',1,'public\\brand\\8.png',1,NULL),(9,'哈哈',1,'/brand/9.png',1,1);
...
insert  into `category`(`id`,`categoryName`,`isDelete`) values (1,'女装',1),(2,'男装',1),(3,'家电',1),(4,'家具',1),(5,'箱包',1),(6,'珠宝',1),(8,'分类1',1),(9,'分类~~~',1);
...
insert  into `product`(`id`,`proName`,`oldPrice`,`price`,`proDesc`,`size`,`statu`,`updateTime`,`num`,`brandId`) values (20,'篮球鞋222',888.1,499.1,'描述','170-195',1,'2017-01-05 00:28:29',20,1),(21,'篮球鞋222',888.1,499.1,'描述','170-195',1,'2017-01-05 00:28:29',20,1),(22,'篮球鞋222',888.1,499.1,'描述','170-195',1,'2017-01-05 00:28:29',20,1),(23,'篮球鞋222',888.1,499.1,'描述','170-195',1,'2017-01-05 00:28:29',20,1),(24,'篮球鞋',8868.1,4969.1,'描述123123','160-190',1,'2017-01-05 00:48:05',22,2);
