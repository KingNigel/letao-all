...
```javascript
 {
  ...
  data: 
   [  { id: 20, proName: '篮球鞋222', price: 499.1, num: 20 },
      ...
      { id: 23, proName: '篮球鞋222', price: 499.1, num: 20, pic: [Object] },
      { id: 24, proName: '篮球鞋', price: 4969.1, num: 22, pic: [Object] } ],
  count: 5 }
```
...
```
### queryHotSecondCategory
+ 接口名称
  火热的二级分类查询
+ 接口地址
   /category/queryHotSecondCategory
+ 请求方式
  GET
+ 参数说明
参数名称|是否必须|说明
